...
(function(global){
  ...
  var DICT = {
    ...
    'tool.line':      ['📏 直線','📏 Line','📏 直线','📏 직선','📏 Đường','📏 Línea','📏 Linie','📏 Ligne','📏 خط'],
    'tip.line':       ['直線・矢印を引く(ドラッグ)。端の形(直線/右矢印/左矢印)と太さ(小/中/大)を切替。色は線色パレット','Draw straight lines/arrows (drag). Switch the end (line/right arrow/left arrow) and thickness (S/M/L). Color from the line palette','绘制直线/箭头(拖动)。切换端点(直线/右箭头/左箭头)和粗细(小/中/大)。颜色用线色面板','직선·화살표(드래그). 끝 모양(직선/오른쪽/왼쪽 화살표)과 굵기(소/중/대) 전환. 색은 선색 팔레트','Vẽ đường thẳng/mũi tên (kéo). Đổi đầu (đường/mũi tên phải/trái) và độ dày (nhỏ/vừa/lớn). Màu từ bảng màu viền','Dibuja líneas/flechas (arrastrar). Cambia el extremo (línea/flecha derecha/izquierda) y el grosor (P/M/G). Color desde la paleta de línea','Linien/Pfeile zeichnen (ziehen). Ende (Linie/Pfeil rechts/links) und Dicke (S/M/L) wechseln. Farbe aus der Linienpalette','Tracez des lignes/flèches (glisser). Changez l’extrémité (ligne/flèche droite/gauche) et l’épaisseur (P/M/G). Couleur depuis la palette de ligne','ارسم خطوطًا/أسهمًا (بالسحب). بدّل الطرف (خط/سهم يمين/يسار) والسماكة (صغير/وسط/كبير). اللون من لوحة الخط'],
    'lbl.linearrow':  ['端','End','端点','끝','Đầu','Extremo','Ende','Extrémité','الطرف'],
    'tip.linearrow':  ['直線の端の形(直線/右矢印/左矢印)','Line end shape (line / right arrow / left arrow)','直线端点形状(直线/右箭头/左箭头)','직선 끝 모양(직선/오른쪽/왼쪽 화살표)','Kiểu đầu đường (đường/mũi tên phải/trái)','Forma del extremo (línea/flecha derecha/izquierda)','Linienende (Linie/Pfeil rechts/links)','Forme de l’extrémité (ligne/flèche droite/gauche)','شكل طرف الخط (خط/سهم يمين/يسار)'],
    'arrow.line':     ['直線','Line','直线','직선','Đường','Línea','Linie','Ligne','خط'],
    'arrow.right':    ['→ 右矢印','→ Right','→ 右箭头','→ 오른쪽','→ Phải','→ Derecha','→ Rechts','→ Droite','→ يمين'],
    'arrow.left':     ['← 左矢印','← Left','← 左箭头','← 왼쪽','← Trái','← Izquierda','← Links','← Gauche','← يسار'],
    'lbl.linew':      ['太さ','Width','粗细','굵기','Độ dày','Grosor','Dicke','Épaisseur','السماكة'],
    'tip.linew':      ['直線の太さ(小/中/大)','Line thickness (S/M/L)','直线粗细(小/中/大)','직선 굵기(소/중/대)','Độ dày đường (nhỏ/vừa/lớn)','Grosor de línea (P/M/G)','Liniendicke (S/M/L)','Épaisseur de ligne (P/M/G)','سماكة الخط (صغير/وسط/كبير)'],
    ...
    'kind.line':      ['直線','Line','直线','직선','Đường','Línea','Linie','Ligne','خط'],
